...
$Msg = $_POST['text'];
$MailServidor = "info@valdimor.com.ar";

$header = 'From: ' . $MailServidor . " \r\n";
        ...
        <center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #f6f6f8;">
          ...
          <table class="header centered" style="border-collapse: collapse;border-spacing: 0;Margin-left: auto;Margin-right: auto;width: 100%;color: gray;">
            <tbody><tr>
              ...
              <td class="logo emb-logo-padding-box" style="padding: 0;vertical-align: middle;mso-line-height-rule: at-least;width: 600px;padding-top: 12px;padding-bottom: 21px;">
                <div class="logo-center" style="font-family: Avenir,sans-serif;color: #38434d;font-weight: bold;Margin-bottom: 0;text-align: center;font-size: 0px !important;line-height: 0 !important;" align="center" id="emb-email-header"><a style="transition: opacity 0.2s ease-in;color: gray;text-decoration: none;" href="http://www.valdimor.com.ar"><img style="border: 0;-ms-interpolation-mode: bicubic;display: block;Margin-left: auto;Margin-right: auto;max-width: 622px;" src="http://www.valdimor.com.ar/mail/images/logo.png" alt="Valdimor Consulting" width="415" height="48" /></a></div>
              </td>
              <td style="padding: 0;vertical-align: middle;">&nbsp;</td>
            </tr>
          </tbody></table>
              ...
              <table class="one-col-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%;">
                ...
                <h2 style="font-style: normal;font-weight: bold;Margin-bottom: 0;Margin-top: 0;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;color: #3e4751;">Contacto Sitio Web</h2><p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 16px;font-size: 13px;line-height: 22px;font-family: PT Serif,Georgia,serif;color: #7c7e7f;">
                  
                  <!-- aca va el texto -->
                  '.$Msg.'<br /><br />Enviado por: '.$Name.'<br />Mail: '.$From.'
                </p>
              ...
              <table class="one-col-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%;">
                ...
                <h1 style="font-style: normal;font-weight: 400;Margin-bottom: 18px;Margin-top: 0;font-size: 22px;line-height: 30px;font-family: Ubuntu,sans-serif;color: #3e4751;">Contacto</h1>
                ...
                <p class="size-13" style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-size: 13px;line-height: 21px;font-family: PT Serif,Georgia,serif;color: #7c7e7f;"><strong style="font-weight: bold;">Direcci&#243;n</strong><br />
    Corrientes 456<br />
    1er piso of. 16,<br />
    Buenos Aires</p><p class="font-ubuntu size-13" style="font-style: normal;font-weight: 400;font-family: ubuntu,sans-serif;Margin-bottom: 0;Margin-top: 22px;font-size: 13px;line-height: 21px;color: #7c7e7f;"><strong style="font-weight: bold;">Telefono:</strong><br />
    +54 11 5218-0202</p><p class="font-ubuntu size-13" style="font-style: normal;font-weight: 400;font-family: ubuntu,sans-serif;Margin-bottom: 0;Margin-top: 22px;font-size: 13px;line-height: 21px;color: #7c7e7f;"><strong style="font-weight: bold;">Email: </strong><br />
    info@valdimor.com.ar</p>
                  ...
                  <tbody><tr>
                    <td style="padding: 0;vertical-align: middle;color: gray;font-size: 12px;line-height: 22px;text-align: left;width: 400px;">
                      ...
                      <div class="address" style="font-family: Ubuntu,sans-serif;Margin-bottom: 18px;">
                        <div>Valdimor Consulting<br />
    www.valdimor.com.ar</div>
                      </div>
...
if(!isset($Name) || !isset($mensaje) || !isset($Msg) || !isset($From) || $Name=="" || $mensaje=="" || $Msg=="" || $From=="" ){
        header('Location: contact.php?i=f');
}else{
    if(mail($MailServidor, $Subject, utf8_decode($mensaje), $header)){
        header('Location: contact.php?i=s');
    }else{
        header('Location: contact.php?i=f');
    }
}
